...
export default function StudentSettingsPage() {
  return (
    <div className="min-h-screen bg-paper">
      <Sidebar />
      <main className="min-h-screen px-5 pb-[calc(84px+1.5rem)] pt-8 md:ml-[280px] md:pb-8 md:pl-8 md:pr-8">
        <div className="mx-auto max-w-3xl rounded-2xl border border-line bg-white p-6 text-center shadow-sm sm:p-10">
          ...
          <p className="mx-auto mt-3 max-w-xl text-sm leading-relaxed text-graphite-soft">
            We are preparing controls for your account preferences, notifications,
            and privacy settings. Please check back soon.
          </p>
        </div>
      </main>
