          ...
          <div className="mx-auto max-w-6xl px-6 py-6 lg:px-10">
            ...
            <Reveal>
              <ProcessStep
                ...
                description="A session-specific code appears on screen — generated fresh for this class, so it only works for this session, in this room, right now."
              >
            ...
            <Reveal>
              <ProcessStep
                number={5}
                audience="System"
                title="Attendance is verified within the class area"
                description="Before a check-in is confirmed, it's checked against the approved area for that class — so attendance reflects students who were actually there."
              >
                <AreaVerifiedMockup />
              </ProcessStep>
            </Reveal>
