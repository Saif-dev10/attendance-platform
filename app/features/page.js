...
export const metadata = {
  ...
  description:
    "Explore every part of Presently's attendance workflow — session control, QR check-in, area verification, live activity, and organized reporting.",
};
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        title: "Approved area verification",
        description: "Check-ins are confirmed against the approved class area, so attendance reflects who was really there.",
      },
    ],
  },
];
            ...
            <Reveal className="order-1 lg:order-2">
              ...
              <div className="mt-6 flex max-w-lg items-start gap-3">
                ...
                <p className="leading-relaxed text-graphite">
                  ...
                  to export whenever a report is needed.
                </p>
              </div>
            </Reveal>
          </div>
