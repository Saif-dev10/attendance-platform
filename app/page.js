...
const coreBenefits = [
  ...
  },
  {
    ...
    description:
      "Every scan is confirmed against the approved class area, so attendance reflects who was actually in the room.",
  },
  {
...
const howItWorksPreview = [
  ...
  { step: "03", title: "Students check in", description: "Each scan is verified within the class area." },
];
...
const featurePreview = [
  ...
  },
  {
    ...
    description: "Check-ins are confirmed against the approved class area automatically.",
  },
  {
    icon: <IconActivity className="h-5 w-5" />,
    title: "Live activity",
            ...
            <div className="grid gap-14 lg:grid-cols-2 lg:items-center">
              <Reveal>
                ...
                <p className="mt-6 max-w-lg leading-relaxed text-graphite">
                  ...
                  code and a location-verified check-in. Lecturers see attendance
                  build in real time, and every session flows straight into
                  organized, reportable records — automatically.
                </p>
                <div className="mt-8">
