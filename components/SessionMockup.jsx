...
const checkIns = [
  { name: "A. Okafor", time: "10:02", status: "In area" },
  { name: "M. Iqbal", time: "10:02", status: "In area" },
  { name: "S. Novak", time: "10:03", status: "In area" },
];
        ...
        <div className="flex items-center gap-5 px-6 py-6">
          ...
          <div className="flex-1">
            ...
            <p className="mt-3 text-sm leading-relaxed text-graphite">
              Displayed to the room. Students scan to check in from their own device.
            </p>
          </div>
        </div>
